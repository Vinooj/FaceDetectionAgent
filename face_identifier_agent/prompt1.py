...
2.  Capture a "target" image after getting user's confirmation.
3.  Execute the `face_matcher` tool using the captured source and target images.
4.  Report the outcome of the face matching.
...
3. Use the capture_image tool to create ./source_image.jpg.
4. Verify the tool's success from its JSON output. Show a confirmation message to the user and display the image path.
...
8. Use the capture_image tool to create ./target_image.jpg.
9. Verify this second capture's success from its JSON output. Show a confirmation message to the user and display the image path.
